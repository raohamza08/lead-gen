...
interface MailboxHealth {
  ...
  // Email Hub inbound-sync fields also live on this same account row (see
  // components/email-hub-accounts-section.tsx), but aren't shown or edited
  // here — this component stays scoped to outbound sending, same as before
  // the Email Hub existed.
}
