 ...
 *  wrapped for the three permission guards to share. EmailModule imported
 *  for TransactionalEmailService (Part: comprehensive operational alerting,
 *  2026-09-08) -- no cycle risk, EmailModule/OrganizationModule don't import
 *  this module back. */
@Global()
@Module({
  imports: [EmailModule],
